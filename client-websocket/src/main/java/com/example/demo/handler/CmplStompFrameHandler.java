...
@Service
public class CmplStompFrameHandler implements StompFrameHandler {
	...
	public void handleFrame(StompHeaders headers, Object payload) {
		...
		L.debug(json);
		scheduleServiceImpl.broadCast(headers.getDestination(), new Gson().fromJson(json, LastCmplVo.class));
	}
}
